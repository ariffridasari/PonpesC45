    ...
    <div class="col-lg-12">
      <div class="card card-default">
        ...
        <div class="card-footer text-right">
          ...
          <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" id="new-soal" onclick="addSoal()">Add
            New</a>
        </div>
        <div class="card-body">
            ...
            <table id="basic-data-table" class="table nowrap" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  {{-- <td>{{ $post->alamat}}</td> --}}
                  <td>
                    <a href="javascript:void(0)" data-id="{{ $soal->id_soal }}" onclick="editSoal(event.target)"
                      class="btn btn-info btn-sm">Edit</a>
                    <a href="javascript:void(0)" data-id="{{ $soal->id_soal }}" onclick="deleteSoal(event.target)"
